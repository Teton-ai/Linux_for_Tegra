...
cp ./kernel_out/kernel-devicetree/generic-dts/dtbs/tegra234-j401-p3768-0000+p3767-0004-reserver-indu.dtb ../kernel/dtb/

cp ./kernel_out/kernel-devicetree/generic-dts/dtbs/tegra234-j201-p3768-0000+p3767-0000-recomputer-indu.dtb ../kernel/dtb/
cp ./kernel_out/kernel-devicetree/generic-dts/dtbs/tegra234-j201-p3768-0000+p3767-0001-recomputer-indu.dtb ../kernel/dtb/
cp ./kernel_out/kernel-devicetree/generic-dts/dtbs/tegra234-j201-p3768-0000+p3767-0003-recomputer-indu.dtb ../kernel/dtb/
cp ./kernel_out/kernel-devicetree/generic-dts/dtbs/tegra234-j201-p3768-0000+p3767-0004-recomputer-indu.dtb ../kernel/dtb/
